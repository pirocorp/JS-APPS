...
myFetch3()
    ...
    //the .catch() block will catch errors occurring in both the async 
    //function call and the promise chain. If you used the try/catch block 
    //here, you might still get unhandled errors in the myFetch3() function 
    //when it's called.
    .catch((e) =>
        console.log(e)
    );